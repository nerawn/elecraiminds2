...
function Sidebar() {
  return (
    <div className="text-white w-72 h-screen flex flex-col  justify-between" style={{ background: '#181A1D' }}>
      <div>
        <div className="p-4">
          <a className="block text-center" href="/">
          <img src="/logo.png" alt="logo" className="w-40 h-40 rounded-full mx-auto mb-4" />

            <h2 className="text-center font-semibold text-xl">electrAI minds</h2>
          </a>
        </div>
        <nav>
          <ul>
            ...
            <li className="px-4 py-2 hover:bg-gray-700 flex items-center py-5">
              <Link href="/PCBHataAyiklama" className="flex items-center w-full">
                <img src="/chip.svg" alt="" className="w-5 h-5 mr-3 fill-white" />
            ...
            <li className="px-4 py-2 hover:bg-gray-700 flex items-center py-5">
              <Link href="/BlesenBilgisi" className="flex items-center w-full">
                <img src="/help.svg" alt="" className="w-5 h-5 mr-3 fill-white" />
                Bileşen Bilgisi
              </Link>
            </li>
            <li className="px-4 py-2 hover:bg-gray-700 flex items-center py-5">
